...
class SipebriTrackingScreen extends ConsumerStatefulWidget {
  final bool showBackButton;
  final VoidCallback? onMenuTap;

  const SipebriTrackingScreen({
    super.key,
  ...
  @override
  ConsumerState<SipebriTrackingScreen> createState() =>
      _SipebriTrackingScreenState();
}

class _SipebriTrackingScreenState extends ConsumerState<SipebriTrackingScreen> {
  ...
  List<String> get _filteredTrackings {
  ...
  Widget build(BuildContext context) {
    final filtered = _filteredTrackings;
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: isEmptyState
            ? null
            : () {
                context.push('/sipebri/tracking-detail', extra: name);
              },
      ),
    );
  }
