...
class SipebriSurveyScreen extends ConsumerStatefulWidget {
  final bool showBackButton;
  final VoidCallback? onMenuTap;

  const SipebriSurveyScreen({
    super.key,
  ...
  @override
  ConsumerState<SipebriSurveyScreen> createState() =>
      _SipebriSurveyScreenState();
}

class _SipebriSurveyScreenState extends ConsumerState<SipebriSurveyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // Dynamic leading icon based on search state
        ...
        onTap: isEmptyState
            ...
            : () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Membuka detail survey untuk $name'),
