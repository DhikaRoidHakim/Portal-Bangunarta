...
class AppTheme {
  ...
  static const Color primaryColor = Color(
    0xFF092966,
  ); // Biru tua/dongker untuk logo, tombol, judul
  ...
  static const Color textPrimary = Color(
    0xFF0A2240,
  ); // Hitam kebiruan untuk judul "Super App"
  static const Color textSecondary = Color(
    0xFF8A98A8,
  ); // Abu-abu kebiruan untuk subtitle
  static const Color textLink = Color(
    0xFF5E718B,
  ); // Abu-abu sedang untuk label username/password
  static const Color textLightBlue = Color(
    0xFF94A3B8,
  ); // Abu-abu muda untuk placeholder & hint
  ...
  static TextStyle footerLink = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w500,
    color: textLightBlue,
  );
